              ...
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> 
                          <a href="detail.html">
                             <img src="{{('frontend/assets/images/products/p10.jpg')}}" alt=""> 
                              <img src="{{('frontend/assets/images/products/p10_hover.jpg')}}" alt="" class="hover-image">
                          </a>
              ...
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> 
                          <a href="detail.html">
                             <img src="{{('frontend/assets/images/products/p2.jpg')}}" alt=""> 
                              <img src="{{('frontend/assets/images/products/p2_hover.jpg')}}" alt="" class="hover-image">
                          </a>
              ...
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> 
                          <a href="detail.html">
                             <img src="{{('frontend/assets/images/products/p3.jpg')}}" alt=""> 
                              <img src="{{('frontend/assets/images/products/p3_hover.jpg')}}" alt="" class="hover-image">
                          </a>
              ...
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> 
                          <a href="detail.html">
                             <img src="{{('frontend/assets/images/products/p1.jpg')}}" alt=""> 
                              <img src="{{('frontend/assets/images/products/p1_hover.jpg')}}" alt="" class="hover-image">
                          </a>
              ...
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> 
                          <a href="detail.html">
                             <img src="{{('frontend/assets/images/products/p7.jpg')}}" alt=""> 
                              <img src="{{('frontend/assets/images/products/p7_hover.jpg')}}" alt="" class="hover-image">
                          </a>
    ...
    <div id="brands-carousel" class="logo-slider">
      <div class="logo-slider-inner">
        <div id="brand-slider" class="owl-carousel brand-slider custom-carousel owl-theme">
          <div class="item m-t-15"> <a href="#" class="image"> <img data-echo="{{('frontend/assets/images/brands/brand1.png" src="assets/images/blank.gif" alt=""> </a> </div>
          <!--/.item-->
          ...
          <div class="item"> <a href="#" class="image"> <img data-echo="{{('frontend/assets/images/brands/brand3.png" src="assets/images/blank.gif" alt=""> </a> </div>
          <!--/.item-->
          
          <div class="item"> <a href="#" class="image"> <img data-echo="{{('frontend/assets/images/brands/brand4.png" src="assets/images/blank.gif" alt=""> </a> </div>
          <!--/.item-->
          
          <div class="item"> <a href="#" class="image"> <img data-echo="{{('frontend/assets/images/brands/brand5.png" src="assets/images/blank.gif" alt=""> </a> </div>
          <!--/.item-->
          
          <div class="item"> <a href="#" class="image"> <img data-echo="{{('frontend/assets/images/brands/brand6.png" src="assets/images/blank.gif" alt=""> </a> </div>
          <!--/.item-->
          
          <div class="item"> <a href="#" class="image"> <img data-echo="{{('frontend/assets/images/brands/brand2.png" src="assets/images/blank.gif" alt=""> </a> </div>
          <!--/.item-->
          
          <div class="item"> <a href="#" class="image"> <img data-echo="{{('frontend/assets/images/brands/brand4.png" src="assets/images/blank.gif" alt=""> </a> </div>
          <!--/.item-->
          
          <div class="item"> <a href="#" class="image"> <img data-echo="{{('frontend/assets/images/brands/brand1.png" src="assets/images/blank.gif" alt=""> </a> </div>
          <!--/.item-->
