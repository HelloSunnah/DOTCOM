                                ...
                                <div class="product-item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <div class="product-action">
                                            <a href="{{route('add-to-cart',$data->id)}}"><i class="fa fa-cart-plus"> </i></a>
                                            <a href="#"><i class="fa fa-heart"></i></a>
                                            <a href="#"><i class="fa fa-search"></i></a>
                                        </div>
                                    </div>
                                    <div class="product-price">
                                        <h3><span>$</span>{{$data->product_price}}</h3>
                                        <a class="btn" href="{{route('add-to-cart',$data->id)}}"><i class="fa fa-shopping-cart"></i>Buy Now</a>
                                    </div>
